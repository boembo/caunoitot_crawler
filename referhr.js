...
const { collectJobDetails } = require('./collectReferHr.js');
...
async function run(){
    ...
    const startPage = 1;
    const recruiteryURL = "https://www.referhr.net/job-list?&page=";
    await page.goto('https://www.referhr.net/job-list', {
